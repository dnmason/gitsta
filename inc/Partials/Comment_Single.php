        ...
        <div class="media-body comment">
            <div class="media-body-wrap panel panel-default <?php echo (($comment->comment_approved == 0) ? 'panel-warning' : ''); ?> comment">
                <div class="panel-heading">
                    ...
                    <span class="text-muted"><small><?php echo get_comment_time('Y-m-d Hi'); ?>&nbsp;(<?php echo human_time_diff( get_comment_time('U'), current_time('timestamp') ) . ' ' .  __('ago', 'gitsta'); ?>)</small></span>
